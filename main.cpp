...
template <typename T>
void insertion_bidirectional_to_high(std::vector<T>&);
template <typename T>
void insertion_to_low(std::vector<T>&);
template <typename T>
void insertion_bidirectional_to_low(std::vector<T>&);
template <typename T>
...
template <typename T>
void insertion_to_high(std::vector<T>& vec) // by random-access iterator that sorts from low to high
{
